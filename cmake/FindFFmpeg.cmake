...
if(WIN32)
  ...
  find_path(AVCODEC_INCLUDE_DIR NAMES libavcodec/avcodec.h PATHS ${_FFMPEG_SEARCH_PATHS} PATH_SUFFIXES include)
...
elseif(APPLE)
  ...
  file(
    GLOB _OBS_DEPS_DIRS
    "${CMAKE_SOURCE_DIR}/.deps/obs-deps-*-universal"
    "${CMAKE_SOURCE_DIR}/.deps/obs-deps-*-arm64"
    "${CMAKE_SOURCE_DIR}/.deps/obs-deps-*-x86_64"
  )
  list(APPEND _FFMPEG_SEARCH_PATHS ${_OBS_DEPS_DIRS})
...
if(FFmpeg_FOUND)
  ...
  if(NOT TARGET FFmpeg::avcodec)
    ...
    set_target_properties(
      FFmpeg::avcodec
      PROPERTIES IMPORTED_LOCATION "${AVCODEC_LIBRARY}" INTERFACE_INCLUDE_DIRECTORIES "${AVCODEC_INCLUDE_DIR}"
    )
  endif()
  ...
  if(NOT TARGET FFmpeg::avutil)
    ...
    set_target_properties(
      FFmpeg::avutil
      PROPERTIES IMPORTED_LOCATION "${AVUTIL_LIBRARY}" INTERFACE_INCLUDE_DIRECTORIES "${AVCODEC_INCLUDE_DIR}"
    )
  endif()
  ...
  if(NOT TARGET FFmpeg::swscale)
    ...
    set_target_properties(
      FFmpeg::swscale
      PROPERTIES IMPORTED_LOCATION "${SWSCALE_LIBRARY}" INTERFACE_INCLUDE_DIRECTORIES "${AVCODEC_INCLUDE_DIR}"
    )
  endif()
endif()
